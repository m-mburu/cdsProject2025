...
* The **second `-m`** is a detailed explanation (optional but highly encouraged).
...
| See commit history       | `git log --oneline`       | One-line view of commit history             |
| Undo last commit (local) | `git reset --soft HEAD~1` | Keeps changes, removes last commit          |
| Stash unfinished work    | `git stash`               | Temporarily save changes without committing |
